TEST = True
TEST_SOLUTION = 24933642 # add solution for test input here
...
def puzzle(filecontent):
    ...
    filesystem_size = filesystem.get_sizes()
    unused_space = DISK_SPACE - filesystem_size
    missing_free_space = UPDATE_SIZE - unused_space
